...
@Component({
  selector: 'app-displaysales-expense',
  templateUrl: './displaysales-expense.component.html',
  styleUrls: ['./displaysales-expense.component.css']
})
export class DisplaysalesExpenseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.dataSource.data= this.pdfopenCloseService.ReadDataToSales();
      }
...
downloaddataExcel()
{
  const workSheet = XLSX.utils.json_to_sheet(this.dataSource.data);
    ...
    XLSX.writeFile(workBook, 'SalesDetails.xlsx');
}
onLinkClick(event)
{
