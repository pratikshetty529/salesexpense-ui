...
onFileSelect(event) {
    if (event.target.files.length > 0) {
      ...
      if(filename && filename.includes('Balance Sheet') && this.myFiles && this.myFiles.length>0 && this.selectedIndex===1)
      {
        this.validation=true;
        this.myFiles.splice(1,this.myFiles.length)
      } 
      if(filename && filename.includes('Balance Sheet') && this.myFiles.length===0)
      {     
      ...
      if(filename && filename.includes('Account list') && this.myFiles && this.myFiles.length===0 && this.selectedIndex===0)
      {
        this.validation=true;
        this.myFiles.splice(0,this.myFiles.length)
      } 
